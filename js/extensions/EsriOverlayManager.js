/**
     ...
     */
define(["esri/layers/KMLLayer", "app/extensions/EsriOverlayManager/Overlay",
    "app/extensions/EsriOverlayManager/Feature", 
    "esri/dijit/InfoWindow", "dojo/on" ],
    function(KMLLayer, OverlayHandler, FeatureHandler, InfoWindow, on) {
     ...
     */
    var EsriOverlayManager = function(payload, errorNotifier, notifier) {
        var me = this;
        me.payload = payload;
        
        var errorNotifier = errorNotifier;
        var infoNotifier = notifier;

        var selectedFeatures = [];

        on(me.payload.map.infoWindow, "hide", function () {
            ...
            for(var i=0; i<selectedFeatures.length; i++){
                /*
                cmwapi.feature.deselected.send({
                    overlayId: selectedFeatures[i].overlayId,
                    featureId: selectedFeatures[i].featureId,
                    deSelectedId: selectedFeatures[i].deselectedId,
                    deSelectedName: selectedFeatures[i].deselectedName
                });                
                */
            }
            selectedFeatures = [];
        ...
        me.pushSelectedFeature = function (selectedFeature) {
        ...
        /**
         * Pass through a call to the common map widget api for data.map.overlay.create
        ...
        /**
         * Pass through a call to the common map widget api for data.map.overlay.remove
        ...
        /**
         * Pass through a call to the common map widget api for data.map.overlay.hide
        ...
        /**
         * Pass through a call to the common map widget api for data.map.overlay.show
        ...
        /**
         * Pass through a call to the common map widget api for data.map.overlay.update
         * @method sendOverlayCreate
         * @param overlayId {String} The id to give to the overlay
         * @param [name] {String} The name to give to the overlay
        ...
        /**
         * Pass through a call to the common map widget api for data.map.feature.plot.url
        ...
        /**
         * Pass through a call to the common map widget api for data.map.feature.unplot
        ...
        /**
         * Pass through a call to the common map widget api for data.map.feature.update
        ...
        /**
         * Pass through a call to the common map widget api for data.map.feature.hide
        ...
        /**
         * Pass through a call to the common map widget api for data.map.feature.show
        ...
        me.archiveState = function() {
            ...
            */
            ...
            var dataValue = JSON.stringify(overlayData);
            /*
        ...
        me.retrieveState = function() {
            ...
            var successHandler = function(retValue) {
                if (retValue && retValue.value) {
                    me.overlays = JSON.parse(retValue.value);
                }
        ...
        me.createDrawOverlay = function (overlayId, overlayName) {            
            me.overlay.createOverlay(OWF.getInstanceId(), overlayId, overlayName);            
        };
    };
