...
define([], function() {
    ...
    About.prototype.toggleAbout = function() {
        ...
        $('#batchselect_wrapper').hide();

        $('#draw_wrapper').hide();
        $('#edit_wrapper').hide();
        $('#draw').removeClass('selected');

        $('#bookmark_wrapper').hide();
        $('#bookmark').removeClass('selected');

        $('#measure_wrapper').hide();
        $('#measure').removeClass('selected');

        $('#quickIcon').removeClass('selected');
        $('#quickIcon_wrapper').hide();

        $('#about_wrapper').toggle();
        $('#about').toggleClass('selected');

        $("#aboutVer").text(window.esriDeployVer);
        $("#aboutDate").text(window.esriDeployDate);
        var formats = { formats: ['kml', 'geojson', 'wms', 'feature', 'dynamic', 'image'] };
    };
